document.addEventListener('DOMContentLoaded', async () => {
  ...
  Router.registerPage('products', 'pages/products.html', () => ProductsModule.init(), true); // Admin only
  Router.registerPage('sales', 'pages/sales.html', () => SalesModule.init(), true);       // Admin only
  Router.registerPage('admin', 'pages/admin.html', () => AdminModule.init(), true);       // Admin only
